...
Written_SDCheader=SDCpckg.Reg.basicHeaderStruct([10 10],'double',1,'varName',...
    'velocity','varUnits','m/s','origin',[1 2],'delta',[7 7],'unit',...
    {'m','m'},'label',{'x','y'})
SDCpckg.Reg.io.JavaSeis.serial.HeaderWrite(dirname,Written_SDCheader);

Read_SDCheader=SDCpckg.Reg.io.JavaSeis.serial.HeaderRead(dirname)
